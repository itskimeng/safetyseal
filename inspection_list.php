        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Inspection and Certification Team</a></li>
                </ol>
            </section>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Province</th>
                                            <th>Name of C/MLGOO</th>
                                            <th>Email Address</th>
                                            <th>Contact Number</th>
                                            <th>Name of COP (PNP)</th>
                                            <th>Name of Fire Marshall(BFP)</th>
                                            <th>ICT Complaint Hotline</th>
                                            <th>Email Address for Complaints</th>
                                            <th>
                                                Checklist
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM tbl_inspection_team";  
                                        ...
                                        if ($result->num_rows > 0) {
                                            while($row = mysqli_fetch_array($result))
                                          {
                                            ECHO '<tr>';
                                              ...
                                              echo '<td>'.$row['PNP'].'</td>';
                                              echo '<td>'.$row['BFP'].'</td>';
                                              echo '<td>'.$row['ICT_HOTLINE'].'</td>';
                                              echo '<td>'.$row['EMAIL_ADDRESS_COMPLAINTS'].'</td>';
