    ...
    <div class="card">
      ...
      <div class="card-body">
        <table class="table table-bordered" style="font-size:10pt;">
          <thead>
            <tr>
              <th width="15%" class="header_pink" rowspan="2" style="vertical-align: middle;">Name of Province</th>
              <th class="header_pink" rowspan="2" style="vertical-align: middle;">Total No. of Applications Received <br><small><i>(Control No.)</i></small></th>
              <th class="header_yellow" rowspan="2" style="vertical-align: middle;">Total No. of Establishments Issued with Safety Seal Certification </th>
              <th class="header_yellow" rowspan="2" style="vertical-align: middle;">Total No. of Disapproved Establishments</th>
