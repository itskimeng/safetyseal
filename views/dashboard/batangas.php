<?php
require_once 'controller/BatangasDashboardController.php'; ?>

<div class="content-header">
    <div class="container">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h5 class="m-0"> SafetySeal Dashboard <small><b><?php echo $hlbl; ?> - BATANGAS</b></small>
                </h5>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<div class="content">
    <div class="container">
        ...
        <?php if ($is_rofp): ?>
            <?php if (isset($_GET['province']) AND $_GET['province'] == 'batangas'): ?>
