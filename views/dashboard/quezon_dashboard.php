                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body bg-ligth" style="background-color: #e2e3e345;">
                                <div class="row">
                                    <!-- <div class="col-md-12"> -->
                                        <div class="col-md-4">
                                            <div class="calabarzon-map" style="width: 445px; margin-bottom: -319px; margin: auto;">
                                            ...
                                            <div class="row" style="font-size:10pt;">
                                                <div class="col-md-6">
                                                    <ul class="chart-legend clearfix">
                                                        <?php foreach ($quezon_muns as $key => $value): ?>
                                                            <?php if ($key > 122): ?>
                                                                <li><i class="far fa-circle text-success"></i> <b><?php echo $value; ?></b></li>
                                        ...
                                        <div class="col-md-4">
                                            <div style="background-color: #e8e8e8; padding: 15px;">
                                                ...
                                                <a type="button" class="info-box mb-1 bg-green2" style="color:white;">
                                                  <span class="info-box-icon"><i class="fas fa-map-marker-alt"></i></i></span>
