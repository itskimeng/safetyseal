                                    ...
                                    <!-- <div class="col-md-12"> -->
                                        <div class="col-md-4">
                                            <div class="calabarzon-map" style="width: 381px; margin-bottom: -319px; margin: auto;">
                                                <img src="_images/batangas2.png" style="max-width: 100%;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="row" style="font-size:10pt;">
                                                <div class="col-md-6">
                                                    <ul class="chart-legend clearfix">
                                                        <?php foreach ($batangas_muns as $key => $value): ?>
                                                            <?php if ($key > 74): ?>
                                                                <li><i class="far fa-circle text-info"></i> <b><?php echo $value; ?></b></li>
                                        ...
                                        <div class="col-md-4">
                                            <div style="background-color: #e8e8e8; padding: 15px;">
                                                ...
                                                <a href="dashboard.v2.php?username=<?php echo $_GET['username']; ?>&province=laguna" class="info-box mb-1 bg-red2 laguna-province" style="color:white;">
                                                  <span class="info-box-icon"><i class="fas fa-map-marker-alt"></i></i></span>
                                                ...
                                                <a type="button" class="info-box mb-1 bg-blue2 batangas-province" style="color:white;">
                                                  <span class="info-box-icon"><i class="fas fa-map-marker-alt"></i></i></span>
    ...
    <div class="col-lg-12">
        <div class="row">
                        ...
                        <div class="col-sm-12">
                            <?php if(!empty($est_safety_seal)): ?>
                                <?php foreach ($est_safety_seal as $key => $establishments) : ?>
                                    <div class="row" style="border-radius: 5px; border: solid 1px #19aaff; margin-bottom: 3px;">
                                        <div class="col-sm-7">
            ...
            <div class="col-md-8" style="border-radius:5px">
                <div class=" card box box-success">
                    <div class="card-header" style="background-color: #009688; color:#fff;">
                        <h5>BATANGAS - MONTHLY UPDATES</h5> 
                    </div>
                    <div class="box-header with-border">
