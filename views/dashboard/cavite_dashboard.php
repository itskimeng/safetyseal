                                    ...
                                    <!-- <div class="col-md-12"> -->
                                        <div class="col-md-4">
                                            <div class="calabarzon-map" style="width: 381px; margin-bottom: -319px; margin: auto;">
                                                <img src="_images/cavite3.png" style="max-width: 100%;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="row" style="font-size:10pt;">
                                                <div class="col-md-6">
                                                    <ul class="chart-legend clearfix">
                                                        <?php foreach ($cavite_muns as $key => $value): ?>
                                                            <?php if ($key > 21): ?>
                                        ...
                                        <div class="col-md-4">
                                            <div style="background-color: #e8e8e8; padding: 15px;">
                                                ...
                                                <a type="button" class="info-box mb-1 bg-warning cavite-province">
