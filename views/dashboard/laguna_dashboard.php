                                    ...
                                    <!-- <div class="col-md-12"> -->
                                        <div class="col-md-4">
                                            <div class="calabarzon-map" style="width: 381px; margin-bottom: -319px; margin: auto;">
                                                <img src="_images/laguna2.png" style="max-width: 100%;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="row" style="font-size:10pt;">
                                                <div class="col-md-6">
                                                    <ul class="chart-legend clearfix">
                                                        <?php foreach ($laguna_muns as $key => $value): ?>
                                                            <?php if ($key > 44): ?>
                                                                <li><i class="far fa-circle text-danger"></i> <b><?php echo $value; ?></b></li>
            ...
            <div class="col-md-4">
                <div class="card" style="height: 562px;">
                    <div class="card-header" style="background-color: #009688; color:#fff;">
                        ...
                        <a href="entity/ssc_establishment_print.php?province=laguna" class="btn btn-sm btn-info" style="float: right;"><i class="fa fa-print"></i> Print</a>
                    </div>
