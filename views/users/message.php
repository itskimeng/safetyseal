...
<html lang="en">
	<head>
		...
		<title>Safetyseal Portal - User Verification</title>
	</head>
	<body>
		<div align="center" style="width: 640px; font-family: Arial, Helvetica, sans-serif; font-size: 14px;">
			<table class="table table-bordered">
				<tbody>
					<tr>
						<td align="center" style="border:1px solid #f0f0f0; padding:10px;">
							<p>
					...
					<tr>
						<td align="center" style="font-size:10px; padding:20px">
                            © Safetyseal DILG IV-A CALABARZON 2022.
						</td>
					</tr>
				</tbody>
			</table>
