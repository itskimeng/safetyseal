<div class="panel panel-default">
  ...
  <div class="table-responsive p-0" style="height: 700px;">
    <table class="table table-responsive table-hover table-striped tableFixHead" style="font-size: 11pt;" >
      ...
      <?php 
      $checklistTable = ($_GET['form'] == 'create_new' || $_GET['form'] == 1) ? 
      setChecklistForm($appchecklists,$alert_level,$userinfo) : 
      setChecklistFormv1($appchecklists,$appchecklists_attchmnt) ;
      ?>
    </table>
  </div>
</div>
...
<?php
    ...
    {
      $th = ($form == 'create_new' || $form == 1) ? '<th class="text-center" style="width:2%;">#</th>
                                                      ...
                                                      '<th class="text-center" colspan="2">MINIMUM PUBLIC HEALTH STANDARDS</th>
                                                      <th class="text-center" style="width:2%;">YES</th>
                                                      <th class="text-center" style="width:2%;">NO</th>
                                                      <th class="text-center" style="width:2%;">N/A</th>
                                                      <th class="text-center" style="width:10%;">Reason why N/A</th>
                                                      <th class="text-center" style="width:10%;">Attachments</th>';
      return $th;
    }
    function setChecklistForm($appchecklists,$alert_level,$userinfo){
      ?>
    ...
    function setChecklistFormv1($appchecklists,$appchecklists_attchmnt){
      ?>
      <tbody id="chklist_body">
        <?php $w=1;$x = 1;$y=3.1;$z=3.2; ?>
        <td colspan="9" class="parent-header" style="font-weight:bold;font-size:15pt;"><strong>STAFF</strong></td>
        <?php foreach ($appchecklists as $key => $list) : ?>
          ...
          <tr id="chklist_tr">
            ...
            <td class="text-center">
              <div class="form-group">
                <?php if ($list['otherTool_disabled']) : ?>
                  <input style="width:1.75em!important;height:1.75em!important;border-radius:0.50em!important;margin-top:0.50em!important;" class="form-check-input chklist_yes" 
                  id="chklist_yes<?=$list['id'];?>" 
                  type="checkbox" 
                  value="" 
                  name="chklist_yes[<?php echo $list['clist_id']; ?>]" 
                  data-chkcol="yes" <?php echo $list['answer'] == 'yes' ? 'checked' : ''; ?> <?php echo $list['is_disabled'] ? 'disabled' : ''; ?>>
                <?php else : ?>
                  <?php if ($list['tracing_tool'] == 'others') : ?>
                    <input class="form-check-input chklist_yes" type="checkbox" value="" name="chklist_yes[<?php echo $list['clist_id']; ?>]" data-chkcol="yes" disabled>
                  <?php else : ?>
            ...
            <td class="text-center">
              <div class="form-group">
                <?php if ($list['otherTool_disabled']) : ?>
                  <input class="form-check-input chklist_no" id="chklist_no<?=$list['id'];?>" type="checkbox" value="" name="chklist_no[<?php echo $list['clist_id']; ?>]" data-chkcol="no" <?php echo $list['answer'] == 'no' ? 'checked' : ''; ?> <?php echo $list['is_disabled'] ? 'disabled' : ''; ?>>
                <?php else : ?>
                  <?php if ($list['tracing_tool'] == 'others') : ?>
                    <input class="form-check-input chklist_no" type="checkbox" value="" name="chklist_no[<?php echo $list['clist_id']; ?>]" data-chkcol="no" disabled>
                  <?php else : ?>
            ...
            <td class="text-center">
              <div class="form-group">
                <?php if ($list['otherTool_disabled']) : ?>
                  <input class="form-check-input chklist_na" id="chklist_na<?=$list['id'];?>" type="checkbox" value="" name="chklist_na[<?php echo $list['clist_id']; ?>]" data-chkcol="na" <?php echo $list['answer'] == 'n/a' ? 'checked' : ''; ?> <?php echo $list['is_disabled'] ? 'disabled' : ''; ?>>
                <?php else : ?>
                  <?php if ($list['tracing_tool'] == 'others') : ?>
                    <input class="form-check-input chklist_na" type="checkbox" value="" name="chklist_na[<?php echo $list['clist_id']; ?>]" data-chkcol="na" disabled>
                  <?php else : ?>
