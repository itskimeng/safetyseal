  ...
  <div class="row mt-5 mb-5">
    <div class="col-lg-12">
      <div class="row">
        <div class="col-md-4">
          <center>
            <img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=http%3A%2F%2Festablishment-profile?unique_id=<?php echo $establishmentId; ?>%2F&choe=UTF-8" title="Link to Google.com" />
          </center>
        </div>
