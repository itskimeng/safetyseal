            ...
            <div class="container mb-3 pt-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <form action="../entity/post_account.php" enctype="multipart/form-data" method="POST">
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="box tab-pane fade shadow rounded bg-white show active p-2" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                    ...
                                    <div class="box-body">
                                        <div class="row mb-3">
                                            <?= group_input_custom('Name', 'fullname', 'fullname', $user_info['name']); ?>
                                        </div>
                                        <div class="row mb-3">
                                            <?= group_input_custom('Position', 'position', 'position', $user_info['position']); ?>
                                        </div>
                                        <div class="row mb-3">
                                            <?= group_input_custom('Contact Number', 'mobile_no', 'mobile_no', $user_info['phone_no'], ['type'=>'number']); ?>
                                        </div>
                                        <div class="row mb-3">
                                            <?= group_input_custom('Email Address', 'email', 'email', $user_info['emailladdress'], ['type'=>'email']); ?>
                                        </div>
                                    </div>

                                    <div class="box-body">
                                        <div class="row mb-3">
                                            <?= group_input_custom('Username', 'username', 'username', $user_info['username']); ?>
                                        </div>
                                        <div class="row mb-3">
                                            <?= group_input_custom('Password', 'password', 'password', '', ['type'=>'password']); ?>
                                        </div>
                                        <div class="row mb-3">
                                            <?= group_input_custom('Confirm Password', 'confirm_password', 'confirm_password', '', ['type'=>'password']); ?>
                                        </div>
                                    </div>
