...
$client = getGoogleClient('https://localhost/safetyseal/admin_verification_page.php');
...
if (isset($_GET['gcode']) AND !empty($_GET['gcode'])) {
    $_SESSION['accessToken'] = $client->authenticate($_GET['gcode']);
