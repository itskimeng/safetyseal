...
foreach ($notify as $key => $data) {
	...
	updateSendingStatus($conn, $control_no);
			...
			<div class="container>
				<div class="card shadow" style="width:30rem">
					...
					<div class="card-body" style="background-color:ECEFF1"><br>
						<br> Hi,  '.$applicant_name.'!, ' . strtoupper($est) . '</br> applied for Safety Seal Certification with CTRL No <b>'.$control_no.'</b><br><br>
...
function updateSendingStatus($conn, $cn)
{
    $sql = "UPDATE `tbl_app_checklist` SET `email_sending_status` = '0' where control_no ='$cn'";
